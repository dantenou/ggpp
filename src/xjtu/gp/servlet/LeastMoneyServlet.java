...
/**
 * Servlet implementation class LeastMoneyServlet
 */
@WebServlet("/LeastMoney")
public class LeastMoneyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LeastMoneyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			ArrayList<House> arLM=HouseService.SortByRent(ar);
			request.setAttribute("HouseArr", arLM);
		}catch(Exception e){
