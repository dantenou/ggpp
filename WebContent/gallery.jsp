	...
	<div id="blog-listing" class="grid-style">
		...
		<div class="container">
			<div class="controls text-center pull-left" data-wow-duration="1s">
				<span class="control active" data-filter="all">优质房屋展示：</span> 
			</div>
			<div class="pull-right">
				<p class="pull-left layout-view">
					视图：<i class="fa fa-th selected" data-layout="4"></i> 
					<i class="fa fa-th-large" data-layout="6"></i>
				</p>
			</div>
		</div>
		</header>
					...
					<div class='col-md-4 col-sm-6 layout-item-wrap mix a1'>
						<article class="gallery-item property layout-item clearfix wow slideInUp">
							<a class="clearfix zoom" href="<%=h.getSrc() %>">
								<img data-action="zoom" src="<%=h.getImg() %>" 
									alt="暂无图片展示" style="width:100%;">
							</a> 
							<span class="btn btn-warning btn-sale">出租中</span> 
						</article>
					</div>
						<%
					}
